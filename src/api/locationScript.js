export function rollApi(searchButton, input) {
    ...
    function geoCode() {
        ...
        input.addEventListener("input", () => {
            ...
            const myAPIKey = "d464031d465347aea999824e70b8ac2c";
    ...
    searchButton.addEventListener('click', () => {
        ...
        if (!input.value) {
            ...
            // currently since the seocnd APi autocompletes, we never end up here. I kept it for user-entered IP address that is invalid. Keep it for now, just to be able to close the if statement
        }
