...
function createLoggedInView() {
  ...
  if (currentUser === 'cathy') {
    loggedinView.innerHTML =
      ...
      '<br><br>Here is your admin panel. You can list your own blocks, all blocks in the chain, and you can test the verification functionality with the hacking tools.' +
